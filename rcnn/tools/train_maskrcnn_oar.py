...
from ..processing.bbox_regression import add_bbox_regression_targets, make_mask_targets_oar
from ..utils.load_data import load_proposal_roidb, merge_roidb #, filter_roidb
from ..utils.load_model import load_param

def train_maskrcnn_oar(network, dataset, image_set, root_path, dataset_path,
    ...
    if osp.exists(roidb_file) and osp.exists(maskdb_file) and osp.exists(mean_file) and osp.exists(std_file):
        ...
        maskdb = make_mask_targets_oar(roidb)
