...
from rcnn.tools.train_maskrcnn_oar import train_maskrcnn_oar
...
def alternate_train(args, ctx, pretrained, epoch,
    ...
    train_maskrcnn_oar(args.network, args.dataset, args.image_set, args.root_path, args.dataset_path,
               args.frequent, args.kvstore, args.work_load_list, args.no_flip, args.no_shuffle, args.resume,
    ...
    # combine_model(model_path+'/rpn2', rpn_epoch, model_path+'/rcnn1', rcnn_epoch, model_path+'/final', 0)
